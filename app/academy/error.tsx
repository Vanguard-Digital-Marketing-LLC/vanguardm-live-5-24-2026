...
export default function AcademyError({
  ...
  useEffect(() => {
    ...
    if (msg.includes("ChunkLoadError") || msg.includes("Loading chunk") || msg.includes("Failed to fetch dynamically imported module")) {
      const key = "chunk_reload_academy";
        ...
        <div className="max-w-lg mx-auto text-center">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-8 md:p-10 shadow-lg">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link href="/academy" className="px-6 py-2.5 rounded-lg border border-white/10 text-slate-300 font-display text-xs font-semibold uppercase tracking-wider hover:border-emerald/30 hover:text-white transition-colors">
                Back to Academy
              </Link>
            </div>
          </div>
